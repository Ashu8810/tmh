      ...
      <div className="max-w-5xl mx-auto px-4 relative z-10">
        ...
        <header className="mb-16 border-b-4 border-[#121212] pb-8 flex flex-col items-start bg-[#0a0a0a] p-8 border-l-4 border-l-[#D71920] relative overflow-hidden">
          ...
          <div className="absolute top-0 right-0 w-32 h-full opacity-20"
               style={{ backgroundImage: 'repeating-linear-gradient(-45deg, #D71920, #D71920 10px, transparent 10px, transparent 20px)' }}
          />
            ...
            return (
              <div 
                ...
                className={`group relative bg-[#0a0a0a] border-2 transition-all duration-300 overflow-hidden ${
                  isUnlocked ? "border-[#D71920] shadow-[0_0_30px_rgba(215,25,32,0.15)]" : "border-[#1f1f1f] hover:border-white/20"
                }`}
              >
                ...
                >
                  <div className="flex items-center gap-6">
                    {/* Lock/Unlock Icon */}
                    <div className={`w-12 h-12 flex items-center justify-center border-2 rounded-sm transition-colors duration-300 ${isUnlocked ? 'border-[#D71920] text-[#D71920]' : 'border-zinc-800 text-zinc-600'}`}>
                      {isUnlocked ? (
                  ...
                  <div className="mt-6 md:mt-0">
                    <span className={`font-mono text-xs font-bold tracking-widest uppercase transition-colors ${isUnlocked ? 'text-[#D71920]' : 'text-zinc-600'}`}>
