...
export const metadata: Metadata = {
  ...
  description: "Explore the fleet of high-performance Student Formula racing cars and prototype vehicles designed and manufactured by Motor Head.",
  ...
  return (
    <main className="flex-1 w-full bg-background text-foreground pt-24 pb-20 px-4">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-4xl font-heading font-bold uppercase mb-8">Our Vehicles</h1>
