import { PenTool, Wrench, Activity, Trophy, BookOpen, Lightbulb } from "lucide-react";
...
export default function WhatWeDoSection() {
  const activities = [
    ...
    },
    {
      ...
      title: "MANUFACTURE",
      description: "Turning ideas into reality with precision and craftsmanship.",
    },
    {
      icon: <Activity className="w-5 h-5 text-[#D71920]" strokeWidth={1.5} />,
      title: "TEST",
      description: "Rigorous testing to ensure reliability, safety and performance.",
    },
    {
      icon: <Trophy className="w-5 h-5 text-[#D71920]" strokeWidth={1.5} />,
      title: "COMPETE",
      description: "Representing our institute at national and international events.",
    },
    {
      icon: <BookOpen className="w-5 h-5 text-[#D71920]" strokeWidth={1.5} />,
      title: "LEARN",
      description: "Upskilling constantly through research, workshops and more.",
    },
    {
  ...
  return (
    <section className="py-24 bg-[#050505] border-b border-white/5 relative">
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16">
          <span className="font-mono text-[#D71920] text-xl block mb-2 font-bold tracking-widest">03</span>
