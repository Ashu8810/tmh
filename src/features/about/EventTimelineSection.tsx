  ...
  return (
    <div className="w-full h-full relative">
      ...
      <div className="relative z-10">
        <div className="mb-8">
          <span className="font-mono text-[#D71920] text-xl block mb-1 font-bold tracking-widest">
            06
          </span>
        ...
        <div className="relative pl-6">
          ...
          <div className="flex flex-col gap-2">
            {events.map((event, index) => (
              <div
                key={index}
                className="flex items-center gap-4 group relative py-1 px-2 -ml-2 rounded-lg hover:bg-white/[0.02] transition-colors cursor-default"
              >
                {/* Node */}
                <div
                  className={`absolute left-[7px] w-2 h-2 rounded-full transition-all duration-300 ${
                ...
                <div className="flex-1 flex items-center gap-4 py-2 px-4 rounded-lg border border-transparent group-hover:border-white/5 bg-transparent group-hover:bg-[#0a0a0a] transition-all duration-300 transform group-hover:translate-x-2">
                  <span className="font-mono text-sm md:text-base text-[#D71920] font-bold w-12 shrink-0 transition-all">
                    {event.year}
                  </span>
