...
export default function OurStorySection() {
  ...
  return (
    <section id="our-story" className="py-24 bg-[#050505] border-b border-white/5 relative">
      <div className="container mx-auto px-6 lg:px-12">
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24">
          ...
          <div className="w-full lg:w-1/3 shrink-0 pt-4">
            <div className="mb-4">
              <span className="font-mono text-[#D71920] text-xl block mb-2 font-bold tracking-widest">01</span>
            ...
            <p className="text-muted-foreground font-medium leading-relaxed mb-8 text-sm md:text-base">
              From a small group of passionate students to a full-fledged engineering team competing on national and international platforms—our journey is built on curiosity, dedication and relentless pursuit of excellence.
            </p>

            <Link href="/about/story" className="inline-flex items-center gap-2 text-[#D71920] hover:text-white font-medium text-sm transition-colors group">
              Read More
                ...
                <div key={index} className="flex flex-col items-start group relative">
                  ...
                  <div className="w-full aspect-[4/3] md:aspect-video bg-[#0a0a0a] border border-white/5 rounded-md mb-6 overflow-hidden relative grayscale group-hover:grayscale-0 transition-all duration-500 shadow-lg">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center opacity-20">
                       <span className="text-white/40 font-mono text-[10px] md:text-xs tracking-widest">IMG_{milestone.year}</span>
                    </div>
                  ...
                  <div className="text-left px-1">
                    <div className="text-white font-bold text-sm mb-1.5">{milestone.year}</div>
                    <h4 className="font-heading text-[11px] font-bold text-white uppercase tracking-wider mb-2">{milestone.title}</h4>
