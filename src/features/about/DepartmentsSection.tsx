...
export default function DepartmentsSection() {
  const departments = [
    {
      name: "Powertrain",
      icon: <Settings className="w-6 h-6 text-[#D71920]" strokeWidth={1.5} />,
    },
    {
      name: "Chassis",
      icon: <Combine className="w-6 h-6 text-[#D71920]" strokeWidth={1.5} />,
    },
    {
      name: "Suspension",
      icon: <Zap className="w-6 h-6 text-[#D71920]" strokeWidth={1.5} />,
    },
    {
      name: "Electrical",
      icon: <Cpu className="w-6 h-6 text-[#D71920]" strokeWidth={1.5} />,
    },
    {
      name: "Aerodynamics",
      icon: <Wind className="w-6 h-6 text-[#D71920]" strokeWidth={1.5} />,
    },
    {
      name: "Manufacturing",
      icon: <Hammer className="w-6 h-6 text-[#D71920]" strokeWidth={1.5} />,
    },
  ];
      ...
      <div className="flex items-center gap-4 relative group">
        ...
        >
          {departments.map((dept, idx) => (
            <div
              key={idx}
              className="w-[120px] md:w-[140px] shrink-0 snap-start flex flex-col items-center gap-4 group/card cursor-pointer"
            >
