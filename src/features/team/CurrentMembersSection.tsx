...
// Current members grouped by batch/pass-out year.
// image: matches the exact filename in Drive — upload with the same name to public/images/members/.
// linkedin: replace "#" with their actual LinkedIn URL whenever you have it.

const membersByYear: Record<string, {
  name: string;
  image: string;
  linkedin: string;
}[]> = {
  "2026": [
    { name: "Aditya Narayan", image: "/images/members/Aditya narayan.jpg", linkedin: "#" },
    ...
    { name: "Raj Surya", image: "/images/members/Raj Surya.jpg", linkedin: "#" },
    { name: "Sahil", image: "/images/members/sahil.jpg", linkedin: "#" },
    { name: "Sharath", image: "/images/members/sharath.jpg", linkedin: "#" },
    { name: "Tanish", image: "/images/members/tanish.jpg", linkedin: "#" },
    { name: "Tharun", image: "/images/members/tharun.jpg", linkedin: "#" },
    { name: "Vikas", image: "/images/members/vikas.jpg", linkedin: "#" },
    { name: "Vinay", image: "/images/members/Vinay.jpg", linkedin: "#" },
  ],
  "2027": [
    { name: "Abhijeeth", image: "/images/members/Abhijeeth.jpg", linkedin: "#" },
    { name: "Aditya Singh", image: "/images/members/Aditya Singh.jpg", linkedin: "#" },
    { name: "DJ", image: "/images/members/DJ.jpg", linkedin: "#" },
    { name: "Gautam P", image: "/images/members/GAUTAM P.jpg", linkedin: "#" },
    { name: "Shankar", image: "/images/members/Shankar.jpg", linkedin: "#" },
    { name: "Venkat", image: "/images/members/Venkat.jpg", linkedin: "#" },
  ],
  "2028": [
    { name: "Aaron Joel Jonathan", image: "/images/members/Aaron Joel Jonathan.jpg", linkedin: "#" },
    { name: "Aashish S Badiger", image: "/images/members/Aashish S Badiger.jpg", linkedin: "#" },
    { name: "Aatif Mohideen", image: "/images/members/Aatif Mohideen.jpg", linkedin: "#" },
    { name: "Arjun Livik J P", image: "/images/members/Arjun Livik J P.jpg", linkedin: "#" },
    { name: "Asim", image: "/images/members/Asim.jpg", linkedin: "#" },
    { name: "Bhagyesh S", image: "/images/members/Bhagyesh S.jpg", linkedin: "#" },
    { name: "Hariharan N", image: "/images/members/Hariharan N.jpg", linkedin: "#" },
    { name: "Karthik Gopal Halliyal", image: "/images/members/Karthik Gopal Halliyal.jpg", linkedin: "#" },
    { name: "Maruthi H R", image: "/images/members/Maruthi H R.jpg", linkedin: "#" },
    { name: "Mohammed Abdul", image: "/images/members/Mohammed Abdul.jpg", linkedin: "#" },
    { name: "Mohith M", image: "/images/members/Mohith M.jpg", linkedin: "#" },
    { name: "Nethanya G H", image: "/images/members/Nethanya G H.jpg", linkedin: "#" },
    { name: "Poojit", image: "/images/members/Poojit.jpg", linkedin: "#" },
    { name: "Pranjal Raj", image: "/images/members/Pranjal Raj.jpg", linkedin: "#" },
    { name: "Pratham", image: "/images/members/Pratham.jpg", linkedin: "#" },
    { name: "Samarth M Hulamani", image: "/images/members/Samarth M Hulamani.jpg", linkedin: "#" },
    { name: "Srujan A P", image: "/images/members/Srujan A P.jpg", linkedin: "#" },
    { name: "Suteerth", image: "/images/members/Suteerth.jpg", linkedin: "#" },
    { name: "Vivek DB", image: "/images/members/Vivek db.jpg", linkedin: "#" },
    { name: "Yashraj Desai", image: "/images/members/Yashraj Desai.jpg", linkedin: "#" },
  ],
};
        ...
        <div>
          <div className="relative w-full max-w-[240px] mb-6">
            ...
            <button
              ...
              className="w-full flex items-center justify-between bg-[#121212] border border-white/10 rounded-lg px-4 py-3 text-left hover:border-white/30 transition-colors focus:outline-none focus:ring-0"
            >
