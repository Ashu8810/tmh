...
const getMembersForYear = (year: string) => {
  ...
  const roles = ["Team Lead", "Technical Lead", "Chassis Lead", "Powertrain Lead", "Electronics Lead", "Suspension Lead", "Aerodynamics Lead", "Operations Lead", "Manufacturing Lead"];
  const firstNames = ["Arun", "Prajwal", "Meghana", "Varun", "Shruti", "Aditya", "Nikhil", "Sneha", "Rahul", "Kavya", "Rohit", "Ananya", "Vikram", "Neha", "Karan"];
  const lastInitials = ["M.", "R.", "S.", "H.", "K.", "P.", "V.", "N.", "D.", "A."];
  ...
  return (
    <section className="flex flex-col lg:flex-row gap-12 lg:gap-24 w-full">
      ...
      <div className="lg:w-1/3 flex flex-col pt-4">
        <span className="text-primary font-heading text-2xl font-bold mb-2">06</span>
        <h2 className="text-3xl font-heading font-bold uppercase tracking-wider mb-6">
          Historical Members
        </h2>
        <div className="w-12 h-1 bg-white/10 mb-6" />
        <p className="text-muted-foreground mb-8">
          The foundation of our success. Explore the brilliant minds that built our legacy over the years.
        </p>
          ...
          {members.map((person) => (
            ...
            >
              ...
              <div className="p-4 text-center">
                <h3 className="font-heading font-bold text-sm md:text-base mb-1">{person.name}</h3>
