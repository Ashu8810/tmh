...
const coordinators = [
  ...
  },
  {
    ...
    role: "Co-Coordinator",
    description: "Mentoring the team and ensuring excellence in every step we take.",
  ...
  return (
    <section className="flex flex-col lg:flex-row gap-12 lg:gap-24 w-full">
      ...
      <div className="lg:w-1/3 flex flex-col pt-4">
        <span className="text-primary font-heading text-2xl font-bold mb-2">01</span>
        ...
        {coordinators.map((coordinator) => (
          ...
          >
            ...
            <div className="w-3/5 p-6 flex flex-col justify-center">
              <h3 className="font-heading font-bold text-xl mb-1">{coordinator.name}</h3>
              <p className="text-primary text-xs font-semibold mb-3 uppercase tracking-wider">{coordinator.role}</p>
