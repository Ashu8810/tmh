    ...
    <nav className="sticky top-0 z-50 w-full border-b border-border/40 bg-[#0a0a0a]/95 backdrop-blur-md">
      <div className="relative z-50 mx-auto flex h-20 w-full items-center justify-between px-4 sm:px-6 lg:px-8 xl:px-4 2xl:px-12 bg-[#0a0a0a]/95 backdrop-blur-md">
        ...
        <div className="flex shrink-0 items-center">
          <Link href="/" className="flex items-center group focus:outline-none focus:ring-1 focus:ring-primary rounded-sm min-h-[44px]">
            {/* Logo Image */}
            <img 
              src="/images/logo.png" 
              alt="Motor Head Logo" 
      ...
      >
        ...
        <div className={`mt-4 pt-4 flex flex-col sm:flex-row gap-4 border-t border-white/10 transition-all duration-500 delay-300 ${isMobileMenuOpen ? "translate-y-0 opacity-100" : "translate-y-4 opacity-0"}`}>
          <Link
            href="/join"
